function Get-SystemInformation {
    ...
    Write-Output "Speed (MHz): $($processor.MaxClockSpeed)"
    Write-Output "Number of Cores: $($processor.NumberOfCores)"
    Write-Output "L1 Cache Size: $(Format-MemorySize $processor.L1CacheSize)"
    Write-Output "L2 Cache Size: $(Format-MemorySize $processor.L2CacheSize)"
    Write-Output "L3 Cache Size: $(Format-MemorySize $processor.L3CacheSize)"
...
# Adding network adapter configuration report from lab 3 here
